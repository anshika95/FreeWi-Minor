...
public class WiFiBroadcastReceiver extends BroadcastReceiver {
	...
	private void changeState(DetailedState aState, Context context) {
		if (aState == DetailedState.SCANNING) {
			...
			RouterManager.setSelf(new MultipleClients(wifiManager.getConnectionInfo().getMacAddress(),
					socketInfo.GO_IP, wifiManager.getConnectionInfo().getMacAddress(), wifiManager
